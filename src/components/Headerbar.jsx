            ...
            <div className='w-[360px] border-r border-gray-200'>
                <div className='pl-6 pr-4 py-5'>
                    <div className='flex items-center justify-between'>
                        ...
                        <button className='px-4 py-1 border shadow-sm border-teal-600 text-sm font-medium   bg-teal-500 text-white rounded-md' onClick={handleAddTable}>+ Add Table</button>
                    </div>
                </div>
            </div>
